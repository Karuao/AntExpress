                    ...
                    <div class="col-4">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item border border-primary p-3">
                                <a href="" class="active nav-link" data-toggle="pill" data-target="#tabone">Employee</a>
                            </li>
                            <li class="nav-item border border-primary p-3">
                                <a class="nav-link" href="" data-toggle="pill" data-target="#tabtwo">Department</a>
                            </li>
                            <li class="nav-item border border-primary p-3">
                                <a href="" class="nav-link" data-toggle="pill" data-target="#tabthree">Occupation</a>
                            </li>
                        </ul>
                    </div>
